...
const rutaBackend =  `${window.location.protocol}//${window.location.hostname}:3000/api`;
...
export {peticionDELETE, peticionGET, peticionPOSTJSON, peticionPOST, peticionPUT};